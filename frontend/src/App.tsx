...
type LayoutState = "default" | "sidesExpanded" | "positionsExpanded";
...
export default function App() {
  ...
  const activeView = useMemo(() => {
    const startX = 0;
    const viewWidth = TOTAL_COLS * COL_WIDTH;
    ...
    <div className="gt-shell">
      <div className="gt-topbar">
        ...
        <div className="gt-controls">
          ...
          <button className={layoutState === "sidesExpanded" ? "active" : ""} onClick={() => setLayoutState("sidesExpanded")}>Outer + Watchlist/Scanners</button>
          <button className={layoutState === "positionsExpanded" ? "active" : ""} onClick={() => setLayoutState("positionsExpanded")}>Outer + Positions</button>
        </div>
      </div>
        ...
        <div className="gt-world" style={{ width: `${worldWidth}px`, height: `${SHEET_HEIGHT}px` }}>
          <div className="gt-grid">
            ...
            <div className="gt-panel gt-green" style={areaStyle(layout.watchlist)}>
              ...
              <div className="gt-panel-sub">{layoutState === "sidesExpanded" ? "Expanded" : "Collapsed"}</div>
            ...
            <div className="gt-panel gt-blue" style={areaStyle(layout.positions)}>
              ...
              <div className="gt-panel-sub">{layoutState === "positionsExpanded" ? "Expanded" : "Collapsed"}</div>
