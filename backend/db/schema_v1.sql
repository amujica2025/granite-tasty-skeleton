...
CREATE INDEX IF NOT EXISTS idx_journal_created_desc ON journal_entries (created_ts DESC);
CREATE INDEX IF NOT EXISTS idx_journal_symbol_created ON journal_entries (symbol, created_ts DESC);
...
CREATE INDEX IF NOT EXISTS idx_alerts_symbol_enabled ON alerts (symbol, is_enabled);
...
CREATE INDEX IF NOT EXISTS idx_alert_events_alert_ts ON alert_events (alert_id, fired_ts DESC);
...
('pct_change', '% Change', 'number', 'quotes_current', 'symbol', true),
