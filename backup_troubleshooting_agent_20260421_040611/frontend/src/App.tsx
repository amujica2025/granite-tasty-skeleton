...
export default function App() {
  ...
  const artifactStore = useArtifactStore();  const openArtifactTestHook = () => {
    artifactStore.openArtifact({
      artifact_id: 'artifact_test_hook',
      artifact_type: 'chart',
      title: 'Artifact Test Hook',
      subtitle: 'Temporary launch hook',
      source: 'positions',
      context_payload: {},
  ...
  return (
    <>
      ...
      {isJournalOpen ? <JournalPopup onClose={() => setIsJournalOpen(false)} /> : null}
