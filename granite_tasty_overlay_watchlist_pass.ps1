# granite_tasty_overlay_watchlist_pass.ps1
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ flex: '0 0 300px', background: '#111', borderRadius: '8px', padding: '10px' }}>
          KPI BLOCK
        </div>
        ...
        <div style={{ width: '350px', display: 'flex', flexDirection: 'column', gap: '8px' }}>
          <div style={{ flex: 1, background: '#111', borderRadius: '8px', padding: '10px' }}>VOL</div>
          <div style={{ flex: 1, background: '#111', borderRadius: '8px', padding: '10px' }}>SCANNER</div>
        </div>
      </div>
...
Write-Host "Overlay watchlist applied. Rebuild frontend."
